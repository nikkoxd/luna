...
export default class ConfigCommand extends Command {
    constructor() {
        super(new SlashCommandBuilder()
            ...
            .setDescriptionLocalization("ru", "Команды связанные с конфигурацией бота")
            .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
            .addSubcommand(subcommand =>
                subcommand
                    .setName("view")
                    .setDescription("View the bot configuration")
                    .setDescriptionLocalization("ru", "Просмотр конфигурации бота")
            )
            .addSubcommand(subcommand =>
                subcommand
                    .setName("edit")
                    .setDescription("Edit the bot configuration")
                    .setDescriptionLocalization("ru", "Изменить конфигурацию бота")
                    .addStringOption(option =>
                        option
                            .setName("key")
                            .setDescription("The option to configure")
                            .setDescriptionLocalization("ru", "Опция для изменения")
                            .addChoices(
                    ...
                    .addStringOption(option =>
                        option
                            ...
                            .setDescriptionLocalization("ru", "Значение опции")
                            .setRequired(true)
                    ),
            ),
        )
